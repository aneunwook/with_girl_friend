...
const LoginForm = () => {
    ...
    return (
      ...
      <div className={`${styles.inputWrapper} ${message ? styles.showMessage : ''}`}>
        <input type="email" placeholder="" value={email} onChange={(e) => setEmail(e.target.value)} className={styles.loginField} />
        <span className={styles.floatingLabel}>Email</span>
      </div>
      <div className={`${styles.inputWrapper} ${message ? styles.showMessage : ''}`}>
        <input type="password" placeholder="" value={password} onChange={(e) => setPassword(e.target.value)}  className={styles.loginField} />
        ...
        <div className={styles.goToSignUpContainer}>
              <Link to="/signUp/email" className={styles.loginLink}>Create a New Account</Link>
              <Link to="/signUp/email" className={styles.forgotPassword}>Lost Password?</Link>
        </div>
    </div>
